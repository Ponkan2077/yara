...
<aside>
    ...
    <div class="modalWrapper" id="modalWrapper">
        ...
        <span class="close">&times;</span>
            ...
            <form class="formModal" action="" method="POST" enctype="multipart/form-data">
                ...
                <div class="imgChooseWrapper"> <input type="file" name="image" accept="image/*" class="inputImg" id="imgBtn" hidden>
    ...
    <div class="main">
        ...
        <div class="settingInfoWrapper">
            ...
            <div class="settingInfoWidth"><span class="label">Role:</span><span class="value">Admin</span></div>
        </div>
        </div>
    </div>
    </main>
