...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $admin = $_POST['submitadminBtn'];
    $ban = $_POST['submitBanBtn'];
    $user = $_POST['submiuserBtn'];
    $unban = $_POST['submitunbanbBtn'];
    ...
    <div class="modalWrapper1" id="modalWrapper1">
        <div class="categoryModal" id="userModal">
            <form class="formModal" action="" method="POST">
                ...
                <input type="number" name="userId" id="user_id" hidden>
                <div class="formBtnWrapper" id="btnModalWrap">
                <input type="submit" class="greenBtn" id="submitadminBtn" value="Yes">
    ...
    <div class="modalWrapper2" id="modalWrapper2">
        <div class="categoryModal" id="userModal">
            <form class="formModal" action="" method="POST">
                ...
                <input type="number" name="userId" id="user_id" hidden>
                <div class="formBtnWrapper" id="btnModalWrap">
                <input type="submit" class="greenBtn" id="submituserBtn" value="Yes">
    ...
    <div class="modalWrapper3" id="modalWrapper3">
        <div class="categoryModal" id="userModal">
            <form class="formModal" action="" method="POST">
                ...
                <input type="number" name="userId" id="user_id" hidden>
                <div class="formBtnWrapper" id="btnModalWrap">
                    <input type="submit" class="greenBtn" id="submitunbanBanBtn" value="Yes">
...
<script>
    ...
    userUserBtns.forEach(function(button) {
        button.addEventListener("click", function() {
            const userId = this.value; // Get the user ID from the button's value
            document.getElementById("user_id").value = userId; // Set the user ID in the hidden input field
            document.getElementById("modalWrapper2").style.display = "block"; // Show the modal
        });
    });
    ...
    UnbanUserBtns.forEach(function(button) {
        button.addEventListener("click", function() {
            const userId = this.value; // Get the user ID from the button's value
            document.getElementById("user_id").value = userId; // Set the user ID in the hidden input field
            document.getElementById("modalWrapper3").style.display = "block"; // Show the modal
        });
    });
