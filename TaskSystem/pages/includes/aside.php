...
<div class="asideWrapper">     
    ...
    <nav class="asideNav">
         <ul>
            ...
            <li><button class="logoutBtn" type="submit" id="logOut"><img src="/yara/TaskSystem/assets/icons/logout.svg" href="/yara/TaskSystem/pages/logOut.php">Logout</button></li>
         </ul>
    </nav>
</div>