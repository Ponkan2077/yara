...
<div class="asideWrapper">     
    ...
    <nav class="asideNav">
         <ul>
            ...
            <li class="setting"><a data-active = "setting" href="/yara/TaskSystem/pages/setting.php">SETTINGS</a></li>
            <li class=""><a  data-active ="task" href="/yara/TaskSystem/pages/task.php">TASKS</a></li>
         </ul>
    </nav>
    <div class="logout">
